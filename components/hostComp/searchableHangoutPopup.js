...
const SearchablePopup = (props) => {
  ...
  const addLocation = () => {
    if (selectedItems.length <= 3) {
      var list = selectedItems;
      if (!list.includes(searchTerm)) list.push(searchTerm);
        ...
        <View style={styles.searchContainer}>
          ...
          >
            <CustomTextBox
              ...
              image={require("../../assets/images/compBackgrounds/destination_input_nosearch_bg.png")}
              value={searchTerm}
            />
          </ImageBackground>
        </View>
          ...
          <View style={styles.resultContainer}>
            {selectedItems.length >= 1 ? (
              ...
              <View style={styles.emptyContainer}>
                <Text style={styles.emptyContainerText}>Nothing selected</Text>
              </View>
            )}
